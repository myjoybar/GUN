...
import com.wen.gun.activity.MainActivity;
...
public class UIRippleButton extends UIBaseButton {
	private static String TAG = UIRippleButton.class.getName();
	ICompete iCompete;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN){
        	L.i(TAG, "onTouchEvent:MotionEvent.ACTION_DOWN ");
            pointX = event.getX();
            pointY = event.getY();
            onStartDrawRipple();
        }
...
//            canvas.translate(0, 0);//保持原点
    ...
    public void setCompeteListener( ICompete iCompete){
