...
//			||!recentTaskName.equals("com.miui.home")
				...
				if (!recentTaskName.equals("com.wen.gun")
						&&!recentTaskName.contains("phone")
						&&!recentTaskName.contains("contacts")
						&&!recentTaskName.contains("launcher")
						&&!recentTaskName.contains("home")) {
					...
					//	L.i("MonitorService", "startActivity(intentNewActivity)");
