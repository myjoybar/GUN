package com.wen.gun.circleprogress;
...
public class DonutProgress extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		finishedOuterRect.set(delta, delta, getWidth() - delta, getHeight()
				- delta);
		unfinishedOuterRect.set(delta, delta, getWidth() - delta, getHeight()
				- delta);

	//	float startAngle = -90;
		float innerCircleRadius = (getWidth()
				- Math.min(finishedStrokeWidth, unfinishedStrokeWidth) + Math
